...
expName = 'pAdaptTest6'  # from the Builder filename that created this script
expInfo = {'participant': '', 'session': '001', 'taskVer': '1'}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Andrew\\Documents\\Work\\Projects\\p-adapt-test6\\pAdaptTest6_lastrun.py',
...
targetAngles1 = [40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50, 40, 50]
targetAngles2 = [130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140, 130, 140]
...
rtd = 30
if (taskVer == '1' or taskVer == '2' or taskVer == '3' or taskVer == '4' or taskVer == '5' or taskVer == '6'):
    targetAngles = targetAngles1
    
if (taskVer == '7' or taskVer == '8' or taskVer == '9' or taskVer == '10' or taskVer == '11' or taskVer == '12'):
    targetAngles = targetAngles2
...
for thisTrials2 in trials2:
    ...
    if (taskVer == '1' or taskVer == '7'):
        ang = 30
        rtd = ang*(pi/180)
    if (taskVer == '2' or taskVer == '8'):
        if (trials2.thisN <= 47):
            ang = (trials2.thisN+1)*0.625
            rtd = ang*(pi/180)
        else:
            ang = 30
            rtd = ang*(pi/180)
    if (taskVer == '3' or taskVer == '9'):
        if (trials2.thisN <= 23):
            ang = 7.5
            rtd = ang*(pi/180)
            ...
            ang = 30
            rtd = ang*(pi/180)
    if (taskVer == '4' or taskVer == '10'):
        ang = -30
        rtd = ang*(pi/180)
    if (taskVer == '5'  or taskVer == '11'):
        if (trials2.thisN <= 47):
            ang = -(trials2.thisN+1)*0.625
            rtd = ang*(pi/180)
        else:
...
for thisTrials3 in trials3:
    ...
    if (taskVer == '6' or taskVer == '12'):
        if (trials3.thisN <= 23):
            ang = 7.5
            rtd = ang*(pi/180)
        elif (trials3.thisN > 23 and trials3.thisN <= 47):
            ang = 15
            rtd = ang*(pi/180)
        elif (trials3.thisN > 47 and trials3.thisN <= 71):
            ang = 22.5
            rtd = ang*(pi/180)
        else:
            ang = 30
...
trials4 = data.TrialHandler(nReps=1, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('pAdaptCond4.xlsx'),
...
for thisTrials4 in trials4:
    ...
    targetangle = targetAngles[trials4.thisN]
    targetangle_rad = pi*(targetangle/180)
    targetPos = (cos(targetangle_rad)*0.4, sin(targetangle_rad)*0.4)
