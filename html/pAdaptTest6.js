...
let expName = 'pAdaptTest6';  // from the Builder filename that created this script
let expInfo = {'participant': '', 'session': '001', 'taskVer': '1'};
...
flowScheduler.add(trials4LoopBegin, trials4LoopScheduler);
flowScheduler.add(trials4LoopScheduler);
flowScheduler.add(trials4LoopEnd);
...
function experimentInit() {
  ...
  taskVer = expInfo["taskVer"].toString();
  rtd = 30;
  if (((((((taskVer === "1") || (taskVer === "2")) || (taskVer === "3")) || (taskVer === "4")) || (taskVer === "5")) || (taskVer === "6"))) {
      targetAngles = targetAngles1;
  }
  if (((((((taskVer === "7") || (taskVer === "8")) || (taskVer === "9")) || (taskVer === "10")) || (taskVer === "11")) || (taskVer === "12"))) {
...
function trial2RoutineBegin(trials2) {
  return function () {
    ...
    if (((taskVer === "1") || (taskVer === "7"))) {
        ang = 30;
        rtd = (ang * (pi / 180));
    }
    if (((taskVer === "2") || (taskVer === "8"))) {
        if ((trials2.thisN <= 47)) {
    ...
    if (((taskVer === "4") || (taskVer === "10"))) {
        ang = (- 30);
        rtd = (ang * (pi / 180));
    }
    if (((taskVer === "5") || (taskVer === "11"))) {
        if ((trials2.thisN <= 47)) {
            ang = ((- (trials2.thisN + 1)) * 0.625);
            rtd = (ang * (pi / 180));
        } else {
  ...
  return function () {
    ...
    if (((taskVer === "6") || (taskVer === "12"))) {
        if ((trials3.thisN <= 23)) {
            ...
            if (((trials3.thisN > 23) && (trials3.thisN <= 47))) {
                ang = 15;
                rtd = (ang * (pi / 180));
            } else {
                if (((trials3.thisN > 47) && (trials3.thisN <= 71))) {
                    ang = 22.5;
                    rtd = (ang * (pi / 180));
                } else {
                    ang = 30;
...
function trial4RoutineBegin(trials4) {
  return function () {
